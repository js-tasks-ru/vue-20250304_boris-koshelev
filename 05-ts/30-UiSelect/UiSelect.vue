<script setup lang="ts" generic="TSelectValue extends string">
defineProps<{ options: { text: string; value: TSelectValue }[] }>()
const modelValue = defineModel<TSelectValue>({ required: true })
</script>
